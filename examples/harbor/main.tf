...
locals {
  ...
  external_fqdn = "harbor.example.com"

  # libvirt
  fqdn               = local.external_fqdn
  cidr_ip_address    = "10.10.16.11/24"
  mac                = "50:50:10:10:16:11"
  vcpu               = 1
  memory             = 1024
  ...
  net_cidr_ipv4 = "10.10.16.0/24"
  net_cidr_ipv6 = "2001:db8:ca2:16::/64"
...
module "libvirt_fcos_harbor" {
  ...
  database_root_password = local.database_root_password
